<template>
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top">
        <div class="container">
            <a class="navbar-brand" href="#"><font-awesome-icon icon="fa-solid fa-user-graduate" style="margin-right: 7px;"/>Academetrix</a>
            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="Toggle navigation">
                <span class="navbar-toggler-icon"></span>
            </button>
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <ul class="navbar-nav ms-auto">
                    <li><a class="nav-item nav-link" href="/home_ar">Home</a></li>
                    <li><a class="nav-item nav-link current" href="#">View Users</a></li>
                    <li><a class="nav-item nav-link" href="/adduser_ar">User Registration</a></li>
                    <li><a class="nav-item nav-link" href="/logout_ar">Log Out</a></li>
                </ul>
            </div>
        </div>
    </nav>
    ...
    <div class="container body">
        <div class="row">
            ...
            <!-- <label for="sort" class="col-sm-2 col-md-2 col-form-label">Sort by</label>
        ...
        <div class="row mt-3">
            <div class="col-sm-12">
                <div class="row">
                    ...
                    <label for="filter" class="col-sm-2 col-md-2 col-form-label filter">Filter by</label>
                    <div class="col-sm-4 col-md-2">
                        <select class="form-select form-select-sm" aria-label="Default select example">
